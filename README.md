...
1. We provide the [Penn-Fudan Database](https://github.com/JeremyXSC/SRPR-Net/releases/download/v1.0.0/PennFudanPed.zip), available from https://www.cis.upenn.edu/~jshi/ped_html/.
2. Pretrain the YOLO model on this dataset. We also provide the [checkpoint](https://github.com/JeremyXSC/SRPR-Net/releases/download/v1.0.0/ped.pt) for your quick try.
3. Download the
